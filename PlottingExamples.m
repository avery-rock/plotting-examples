...
figure % Generate new figure for plot
...
% using the builtin functions saveas() or print(), for example: 

% print(gcf, "~/Desktop/output_folder/pretty_figure.png", "-r300", "-dpng")

% will save the current figure as a .png image with the name "pretty_figure.png" at a resolution of
% 300 dpi in the folder "Desktop/output_folder/"
